...
def predict_class(image) :
    with st.spinner('Loading Model...'):
        classifier_model = keras.models.load_model(r'50epochs_maize_potato.h5', compile = False)
    ...
    class_name = ['Blight', 'Common_rust', 'Gray_leaf_spot','Healthy','potato early blight','potato healthy','potato late blight']
